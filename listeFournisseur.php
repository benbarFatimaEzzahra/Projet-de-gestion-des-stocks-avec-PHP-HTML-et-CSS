...
<body>
  ...
  <section class="home-section">
    ...
    <table>
        ...
        <tbody>
            <?php
                foreach ($lst as $f)  {
                    echo "<tr>";
                        echo "<td>" . $f->Id_Fournisseur . "</td>";
                        echo "<td>" . $f->Nom_Fournisseur . "</td>";
                        echo "<td>" . $f->Prenom_Fournisseur . "</td>"; 
                        echo "<td>" . $f->Adresse_Fournisseur . "</td>";
                        echo "<td>" . $f->Tel_Fournisseur . "</td>";
                        echo "<td>" . $f->Mail_Fournisseur . "</td>";
                        echo "<td><a href="."supFourni.php/?id=" .  $f->Id_Fournisseur .  "><i class='fas fa-folder-minus'></i></a></td>";
                        echo "<td><a href="."updateFournisseur.php/?idF=" .  $f->Id_Fournisseur  . "><i class='fas fa-edit'></i></a></td>";
    ...
    <div class="table-footer">
     <a  href="ajoutFournisseur.php">Add</a>
    <a  href="listeFournisseur.php">Show all</a>
    </div>
