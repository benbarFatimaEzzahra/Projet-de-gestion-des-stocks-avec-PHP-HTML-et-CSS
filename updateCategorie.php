    ...
    <nav>
      ...
      <div class="profile-details">
        ...
        <div class="data-input-side">
            ...
            <form action=<?php echo"/project/updateCat.php/?refC=". $c->Reference_Categorie?> method="POST">
            <input type="text" class="input-border" name="descriptionC" id="descriptionC" placeholder="descriptionC" value=<?php echo $c->Description_Categorie ?>>
            <input type="submit" name="update-cat" value="Mettre à jour">
            </form>
