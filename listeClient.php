            ...
            <?php
                foreach ($lst as $c)  {
                    ...
                    echo "<tr>";
                        ...
                        echo "<td>" . $c->Id_Client . "</td>";
                        
                        echo "<td>" . $c->Nom_Client . "</td>";
                        echo "<td>" . $c->Prenom_Client . "</td>"; 
                        echo "<td>" . $c->Mail_Client . "</td>";
                        echo "<td>" . $c->Tel_Client . "</td>";
                       echo "<td>" . $c->Adresse_Client . "</td>";

                        echo "<td><a href="."supClient.php/?id="  . $c->Id_Client . "><i class='fas fa-folder-minus'></i></a></td>";
                        echo "<td><a href="."updateCli.php/?idCli="  . $c->Id_Client  . "><i class='fas fa-edit'></i></a></td>";
