...
<form action="saveCommande.php" method="POST">
            <input type="number" class="input-border" name="num" id="num" placeholder="Num-Commande" required>
            <input type="text" class="input-border" name="idCli" id="idCli" placeholder="idClient" required>
            <input type="date" step="any" class="input-border" name="dateC" id="dateC" placeholder="date de commande">
                 <input type="submit" name="save-Commande" value="Enregistrer">
            </form>  
