...
<form action="saveContenir.php" method="POST">
            ...
            <input type="text" class="input-border" name="quantite" id="quantite" placeholder="quantite commandee" required>
            <input type="submit" name="save-Contenir" value="Enregistrer">
            </form>  
            </div>
            </section>
