    ...
    <nav>
      ...
      <div class="profile-details">
        ...
        <div class="data-input-side">
            ...
            <form action=<?php echo"/project/updateCommande.php/?numC=". $c->Num_Commande?> method="POST">
            <input type="text" class="input-border" name="idCli" id="idCli" placeholder="id Client" value=<?php echo $c->Id_Client ?>>
            <input type="date" step="any" class="input-border" name="dateC" id="dateC" placeholder="date de commande" value=<?php echo $c->Date_Commande ?>>
            <input type="submit" name="update-commande" value="Mettre à jour">
            </form>
