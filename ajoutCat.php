      ...
      <div class="profile-details">
        ...
        <div class="data-input-side">
            ...
            <form action="saveCat.php" method="POST">
                <input type="text" class="input-border" name="refC" id="refC" placeholder="Référence">
                <textarea  class="input-border" name="descriptionC" id="descriptionC" placeholder="Description" rows="5"></textarea >
