...
<div class="data-input-side">
        <form action="saveAppro.php" method="POST">
            <input type="number" class="input-border" name="num" id="num" placeholder="num" required>
            <input type="number" class="input-border" name="id" id="id" placeholder="id Fournisseur" required>
  
            <input type="date" step="any" class="input-border" name="date" id="date" placeholder="date">

            <input type="submit" name="save-appro" value="Enregistrer">
        </form>
    </div>
    <script>
