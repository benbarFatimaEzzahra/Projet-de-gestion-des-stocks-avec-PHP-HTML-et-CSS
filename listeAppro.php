...
<head>
    ...
    <link href='https://unpkg.com/boxicons@2.0.7/css/boxicons.min.css' rel='stylesheet'>
     <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>La liste des approvisionnements</title>
</head>
<body>
  <div class="sidebar">
  ...
  <section class="home-section">
    ...
    <table>
        <thead>
            <tr>
                <th>Num_Approvisionnement</th>
                <th>Id_Fournisseur</th>
                <th>Date_Approvisionnement</th>
                <th>Reference Produit</th>
                <th>Quantite_Approvisionnement</th>
                <th></th>
        ...
        <tbody>
            <?php
                foreach ($lst as $comm)  {
                    echo "<tr>";
                        echo "<td>" . $comm->Num_Approvisionnement . "</td>";
                        echo "<td>" . $comm->Id_Fournisseur . "</td>";
                        echo "<td>" . $comm->Date_Approvisionnement . "</td>"; 
                        echo "<td>" . $comm->Reference_Produit . "</td>";
                        echo "<td>" . $comm->Quantite_Approvisionnement . "</td>";
    ...
    <a href="ajoutAppro.php">Add</a>
    <a href="listeAppro.php">Show all</a>
    </div>
